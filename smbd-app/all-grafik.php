    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-1 p-md-3 bg-body-secondary">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                ...
                <a href="all-grafik.php" class="nav-link active icon-dashboard-item p-0 m-0 py-1 text-center"
                    ...
                    <div class="container pt-4">
                        <section class="mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-end">
                                        <button class="btn btn-primary btn-sm" onclick="resetGas()">Reset</button>
                                    </div>
