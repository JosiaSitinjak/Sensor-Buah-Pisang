...
<body style="overflow: hidden;">
    <div class="d-flex border-dark shadow-sm z-3 position-relative" style="background:#E7B10A;">
    ...
    <div>
        <img src="public/image/pisang22.jpg" width="1600px">
    </div>
    ...
    <div class="container-fluid mt-1">
        <div class="row">
            <div class="col-md-12">
                <form action="login-process.php" method="post" style="background: #FFD93D;">
                    <div class="row">
                        <div class="col-md-12">
